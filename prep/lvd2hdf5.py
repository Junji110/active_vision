...
def load_data_in_chunks(reader, dsfactor=10, chunksize=500000, verbose=False):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dsfactor", type=int, default=100)
    ...
    for i_pc, fn_pc in enumerate(fn_lvd):
        ...
        # save data in hdf5
        fn = "{0}/{1}_rec{2}_pc{3}.hdf5".format(arg.hdf5dir, sess, rec, i_pc+1)
