...
from parameters.eyevex2 import *
...
def main(eyecoil, Fs, calib_coeffs, param, datalen_max=10000000, seg_overlap=100000, calib_order=2, ret_eyepos=False, verbose=False):
    ...
    for i_seg in range(n_seg):
        ...
        eyepos, eyevelo, eyeaccl = eyepos_derivation(eyepos, derivorder=(0, 1, 2), window_length=eex_param['savgol_window_length'], polyorder=eex_param['savgol_polyorder'], fs=Fs, verbose=verbose)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--calib_method", dest="calibmeth", default=calib_method_default)
    parser.add_argument("--calib_param", dest="calibparam", default=calib_param_default)
